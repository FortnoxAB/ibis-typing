...
# Primitives
@overload
def literal(value: bool | None) -> ir.BooleanScalar: ...
@overload
def literal(value: int | None) -> ir.IntegerScalar: ...
@overload
def literal(value: float | None) -> ir.FloatingScalar: ...
@overload
def literal(value: str | None) -> ir.StringScalar: ...
@overload
def literal(value: bytes | None) -> ir.BinaryScalar: ...
# Complex types
@overload
def literal(value: datetime.datetime | None) -> ir.TimestampScalar: ...
@overload
def literal(value: datetime.date | None) -> ir.DateScalar: ...
@overload
def literal(value: datetime.time | None) -> ir.TimeScalar: ...
@overload
def literal(value: decimal.Decimal | None) -> ir.DecimalScalar: ...
# Other
@overload
